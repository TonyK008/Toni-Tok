...
<center>
    <div style="position: relative; display: block;">
        ...
        <a  style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; cursor: pointer;" href="<?= "/Toni-Tok/HTML/partials/titleSearchVideos.php?u_id={$userId}&v_id={$video_id}" ?>"></a>
    </div>
</center>
