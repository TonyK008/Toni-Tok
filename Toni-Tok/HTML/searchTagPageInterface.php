...
<?php
    ...
    if(isset($_GET['search'])){
        ...
        $searches = $db -> query("SELECT title FROM videos WHERE tag LIKE '%{$searching}%'") -> fetchAll(PDO::FETCH_COLUMN);
    ...
    <div id='searchContainer'>
        ...
        <div id='searchPageControls'>
            ...
            <button id='tagSearchControl' style="<?= pageURL("/Toni-Tok/controllers/searchTag.php") ? 'color: #444444; border: none; cursor: pointer; font-size: 2vw ' : '' ?>">tag</button>
        ...
        <div id='searchVideosContainer'><?php
            ...
            require("partials/tagSearchCurrentVideo.php");
        }
        ?></div>
        ...
        <script>
            ...
            searchButton.addEventListener('click', function(){
                ...
                if(search !== ''){
                    window.location.href = `/Toni-Tok/controllers/searchTag.php?search=${search}`;
                } else {
