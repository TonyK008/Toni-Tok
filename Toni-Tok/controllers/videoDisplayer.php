...
if(isset($_SESSION['user']) && $_SESSION['user'] != null){
    ...
    <center>
        ...
        if($currentUser != $uploader){
            echo "<form method='POST' action='' target='hidden_iframe_<?=  $title ?>' class='videoControls'>";
            echo "<div>";
            echo "<button style='" . ($isLiked == 'yes' ? "background-image: url(/Toni-Tok/HTML/images/liked.png)" : '') . "' class='likeButton' data-title='" . $title . "'></button>";
            echo "<p class='likesCounter'>" . $likes . "</p>";
            echo "<input type='hidden' name='title' value='" . $title . "'>";
            echo "</div>";

            echo "<div>";
            echo "<button class='commentButton' data-title='" . $title . "'></button>";
            echo "<p class='commentCounter'>" . $comments . "</p>";
            echo "<input type='hidden' name='title' value='" . $title . "'>";
            echo "</div>";

            echo "<div>";
            echo "<button style='" . ($isFavourited == 'yes' ? "background-image: url(/Toni-Tok/HTML/images/favourited.png)" : '') . "' class='favouriteButton' data-title='" . $title . "'></button>";
            echo "<p class='favouriteCounter'>" . $favourites . "</p>";
            echo "<input type='hidden' name='title' value='" . $title . "'>";
            echo "</div>";
            echo "</form>";
        }else{
            echo "<div class='videoControls'>";
            echo "<div>";
            echo "<a href='/Toni-Tok/HTML/partials/cannotInteract.php'><button style='" . ($isLiked == 'yes' ? "background-image: url(/Toni-Tok/HTML/images/liked.png)" : '') . "' class='likeButton' data-title='" . $title . "'></button></a>";
            echo "<p class='likesCounter'>" . $likes . "</p>";
            echo "<input type='hidden' name='title' value='" . $title . "'>";
            echo "</div>";

            echo "<div>";
            echo "<a href='/Toni-Tok/HTML/partials/cannotInteract.php'><button class='commentButton' data-title='" . $title . "'></button></a>";
            echo "<p class='commentCounter'>" . $comments . "</p>";
            echo "<input type='hidden' name='title' value='" . $title . "'>";
            echo "</div>";

            echo "<div>";
            echo "<a href='/Toni-Tok/HTML/partials/cannotInteract.php'><button style='" . ($isFavourited == 'yes' ? "background-image: url(/Toni-Tok/HTML/images/favourited.png)" : '') . "' class='favouriteButton' data-title='" . $title . "'></button></a>";
            echo "<p class='favouriteCounter'>" . $favourites . "</p>";
            echo "<input type='hidden' name='title' value='" . $title . "'>";
            echo "</div>";
            echo "</div>";
